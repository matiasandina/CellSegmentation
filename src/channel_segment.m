...
% Feed the channel you want to segment

function [out] = channel_segment(img, plotMe)

%% Segmentation for the channel in img
...
median_filtered = my_medfilt2(img, 3, 3, 0);
...
if plotMe
    ...
    imshow(img); hold on; plot(centroids.x, centroids.y, 'rx')
